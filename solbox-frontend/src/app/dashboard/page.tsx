...
export default function page() {
  return (
    <div className=''>
        {/* Hero Section */}
      <div className="bg-lapis rounded-xl p-5 my-4">
      ...
      <div className='grid grid-cols-4 gap-3 my-6'>
        ...
        <div className="flex flex-col gap-2 h-full">
            ...
            <Link href='/collectibles' className='bg-lapis text-white font-bold text-sm p-1 rounded-lg text-center'>
            Collectibles
            </Link>
        </div>
      </div>
      ...
      <div className="flex gap-3 my-6">
        <div className='basis-2/5'>
            <div className='bg-lapis rounded-xl mb-3 p-3'>
                <div className="flex items-center justify-between text-white font-bold text-sm gap-2 py-2">
                    <p>Daily
                    Stream Time</p>
        ...
        <div className='bg-lapis rounded-xl flex flex-col justify-between basis-3/5'>
            <div className="flex text-white justify-between items-center my-5 mx-3">
      ...
      {/* Transactions */}
      <div className='bg-lapis rounded-lg h-[300px] w-full mt-6 p-4'>
